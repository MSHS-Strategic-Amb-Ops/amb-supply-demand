...
slot_raw <- tbl(con, "Y_DM_BOOKED_FILLED_RATE")
slot_data <- slot_raw %>%
  select(DEPARTMENT_NAME, SLOT_BEGIN_TIME)

conn <- dbPool(drv = odbc(), dsn = "Caboodle", timeout = 30)
referrals <- tbl(conn, "Referrals")
